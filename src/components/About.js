  ...
  return (
    <div id="about" className="container-fluid about">
      <div className="container">
        ...
        <p className="desc">Hello, I am Layton, a CS major who enjoys developing games and software in my free time. I’m also very proficient Web Developer. Some of the technologies I use when developing responsive websites include ReactJS, NodeJS, and Bootstrap. Im also well verse in many other software developing technologies such as Java, Rust, and SQL. When I look into the mountainous technological field all I can see is opportunity! I love the idea of always learning new tools and languages to have to my belt. Ultimately, I’m looking for a role where I can grow, learn, and experience new things with great people. </p>
