        ...
        <div className='container'>
            ...
            <div className='row proj-row d-flex'>
                ...
                <div className='col-lg-6'>
                    ...
                    <p className='proj-desc'>Faces+ is an arcade style platformer that gained popularity of over 20,000 players. It was an incredibly simple and beautiful game. This project was great for the public as it was easy to produce content for the popular demands</p>
